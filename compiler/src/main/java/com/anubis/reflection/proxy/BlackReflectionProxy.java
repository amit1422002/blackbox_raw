...
import com.anubis.reflection.BlackReflectionInfo;
import com.anubis.reflection.utils.ClassUtils;


public class BlackReflectionProxy {

    private static final ClassName BR = ClassName.get("com.anubis.reflection", "BlackReflection");
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return com.anubis.reflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
