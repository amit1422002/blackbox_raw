...
import com.anubis.databinding.ActivityMainBinding
import com.anubis.util.Resolution
import com.anubis.util.inflate
import com.anubis.view.apps.AppsFragment
import com.anubis.view.base.LoadingActivity
import com.anubis.view.fake.FakeManagerActivity
import com.anubis.view.list.ListActivity
import com.anubis.view.setting.SettingActivity
...
class MainActivity : LoadingActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            try {
                AnubisCore.get().onBeforeMainActivityOnCreate(this)
            } catch (e: Exception) {
            ...
            try {
                AnubisCore.get().onAfterMainActivityOnCreate(this)
            } catch (e: Exception) {
    ...
    private fun initViewPager() {
        try {
            val userList = AnubisCore.get().users
            ...
            when (item.itemId) {
                R.id.main_git -> {
                    val intent =
                            Intent(
                                    Intent.ACTION_VIEW,
                                    Uri.parse("https://github.com/ALEX5402/Anubis")
                            )
                ...
                R.id.main_tg -> {
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/anubisbox"))
                    startActivity(intent)
                }
                R.id.fake_location -> {
