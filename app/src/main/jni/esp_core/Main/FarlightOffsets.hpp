...
constexpr uintptr_t GWorldExternal     = 0xCB74470;
...
// --- ULevel / ULevelActorContainer (training bots) ---
constexpr uintptr_t LevelActorCluster    = 0xD8;
constexpr uintptr_t ActorClusterActors   = 0x28;

// --- UEngine / UGameViewportClient ---
constexpr uintptr_t EngineGameViewport   = 0x808;
constexpr uintptr_t ViewportWorld          = 0x70;
...
/** AController::ControlRotation — fallback when PCM POV yaw is stale. */
constexpr uintptr_t ControlRotation        = 0x330;

// --- APlayerCameraManager / FCameraCacheEntry / FMinimalViewInfo ---
constexpr uintptr_t CameraCache          = 0x350;
constexpr uintptr_t CameraCachePrivate     = 0x2E00;
...
constexpr uintptr_t PawnController         = 0x318;
