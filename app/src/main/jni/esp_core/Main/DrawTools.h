...
static ImVec4 arr[] = {{144/255.f,238/255.f,144/255.f,tm1},{135/255.f,206/255.f,255/255.f,tm1},{255/255.f,0/255.f,0/255.f,tm1},{0/255.f,255/255.f,0/255.f,tm1},{0 /255.f,255/255.f, 127/255.f,tm1}
...
public:
    ...
    {
        ImGui::GetBackgroundDrawList()->AddRectFilled(ImVec2(x, y), ImVec2(x + w, y + h), (color), rounding, ImDrawFlags_RoundCornersAll);
    }
    ...
    {  //rounding 方框边缘曲率  //rounding_corners_flags 方框边缘弯曲类型  1.ImDrawFlags_RoundCornersAll 2.ImDrawCornerFlags_Top 3. ImDrawCornerFlags_Bot 4. ImDrawCornerFlags_Left 5. ImDrawCornerFlags_Right
       // ImGui::GetBackgroundDrawList()->AddRect(ImVec2(x, y), ImVec2(x+w, y+h), ImGui::ColorConvertFloat4ToU32(color), 10, 0, size);
        ImGui::GetBackgroundDrawList()->AddRect(ImVec2(x, y), ImVec2(x+w, y+h), ImGui::ColorConvertFloat4ToU32(color), 10, ImDrawFlags_RoundCornersAll, size);
    }
